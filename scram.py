...
class ScramPackage(PackageBase):
    ...
    def build(self, spec, prefix):
        ...
        lines.append('$scramcmd b --verbose -f ${compileOptions} ${extraOptions} ' + str(make_jobs) + '${buildtarget} </dev/null || { touch ../build-errors && $scramcmd b -f outputlog && ' + self.ignore_compile_errors + ' }')
