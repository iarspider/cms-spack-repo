...
class Git(AutotoolsPackage):
    ...
    def build(self, spec, prefix):
        ...
        args = ['NO_R_TO_GCC_LINKER=1', 'RUNTIME_PREFIX=1', 'V=1',
                'NO_CROSS_DIRECTORY_HARDLINK=1', 'NO_INSTALL_HARDLINKS=1'] 
    ...
    def install(self, spec, prefix):
        args = ['V=1', 'NO_CROSS_DIRECTORY_HARDLINK=1', 'NO_INSTALL_HARDLINKS=1', 'install']
        if '~nls' in self.spec:
            args.append('NO_GETTEXT=1')
        ...
        install(join_path(self.stage.source_path, 'ca-bundle', 'ca-bundle.crt'), join_path(prefix.share.ssl.certs))
