...
class Gdb(AutotoolsPackage, GNUMirrorPackage):
    ...
    variant('doc', default=True, description='Build documentation')  # -- CMS
    ...
    # Add option to disable building documentation. Provided by CMS
    patch('gdb-disable-makeinfo.patch', when='@10.2:')
