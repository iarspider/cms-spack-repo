...
class Geant4Data(BundlePackage):
    ...
    # geant4@10.7.X
    depends_on("g4ndl@4.6", when='@10.7.0:10.7.99')
    depends_on("g4emlow@7.13", when='@10.7.0:10.7.99')
    depends_on("g4photonevaporation@5.7", when='@10.7.0:10.7.99')
    depends_on("g4radioactivedecay@5.6", when='@10.7.0:10.7.99')
    depends_on("g4particlexs@3.1.1", when='@10.7.1:10.7.99')
    depends_on("g4particlexs@3.1", when='@10.7.0')
    # depends_on("g4pii@1.3", when='@10.7.0:10.7') -- CMS
    depends_on("g4realsurface@2.2", when='@10.7.0:10.7.99')
    depends_on("g4saiddata@2.0", when='@10.7.0:10.7.99')
    depends_on("g4abla@3.1", when='@10.7.0:10.7.99')
    depends_on("g4incl@1.0", when='@10.7.0:10.7.99')
    depends_on("g4ensdfstate@2.3", when='@10.7.0:10.7.99')
