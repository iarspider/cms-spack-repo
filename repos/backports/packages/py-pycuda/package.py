...
class PyPycuda(PythonPackage):
    ...
    version("2022.1", sha256="acd9030d93e76e60b122e33ad16bcf01bb1344f4c304dedff1cd2bffb0f313a3")
    ...
    # From pyproject.toml
    depends_on("py-numpy", when="@2022.1: ^python@3.10:", type=("build", "run"))
    depends_on("py-numpy@1.19.5", when="@2022.1: ^python@3.8:3.9", type=("build", "run"))
    depends_on("py-numpy@1.15.4", when="@2022.1: ^python@3.7", type=("build", "run"))
    depends_on("py-numpy@1.12.1", when="@2022.1: ^python@:3.6", type=("build", "run"))
    # From setup.py
