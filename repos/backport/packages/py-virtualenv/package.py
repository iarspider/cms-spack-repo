...
class PyVirtualenv(PythonPackage):
    ...
    depends_on('python@2.7:2.8,3.5:', type=('build', 'run'), when='@20.7.0:')

    # not just build-time, requires pkg_resources
    depends_on('py-setuptools@40.6.3:', type=('build', 'run'))
    depends_on('py-setuptools@41.00.03:', type=('build', 'run'), when='@20.7.0:')
    depends_on('py-setuptools-scm@2:', type=('build', 'run'), when='@20.7.0:')

    depends_on('py-backports-entry-points-selectable @1.0.4:', type=('build', 'run'), when='@20.7.0:')
    depends_on('py-distlib@0.3.1:0', type=('build', 'run'), when='@20.7.0:')
    depends_on('py-filelock@3.2:3', type=('build', 'run'), when='@20.7.0:')
    depends_on('py-platformdirs@2:2', type=('build', 'run'), when='@20.7.0:')
    depends_on('py-six@1.9.0:1', type=('build', 'run'), when='@20.7.0:')
    depends_on('py-importlib-metadata@0.12:', type=('build', 'run'), when='@20.7.0: ^python@:3.7')
    depends_on('py-importlib-resources@1:', type=('build', 'run'), when='@20.7.0: ^python@:3.6')
    depends_on('py-pathlib2', type=('build', 'run'), when='@20.7.0: ^python@:3.3')
