...
class Go(Package):
    ...
    _versions = {'1.16': {'Linux-x86_64': ('013a489ebb3e24ef3d915abe5b94c3286c070dfe0818d5bca8108f1d6e8440d2',
                                           'https://storage.googleapis.com/golang/go1.16.linux-amd64.tar.gz'),
                          'Linux-aarch64': ('3770f7eb22d05e25fbee8fb53c2a4e897da043eb83c69b9a14f8d98562cd8098',
