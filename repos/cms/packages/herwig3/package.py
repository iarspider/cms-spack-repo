...
class Herwig3(AutotoolsPackage):
    ...
    version(
        "7.2.2",
        sha256="53e06b386df5bc20fe268b6c8ba50f1e62b6744e577d383ec836ea3fc672c383",
    )
    version(
        "7.2.1",
    ...
    def configure_args(self):
        args = [
            "--with-gsl=system",  #  + self.spec['gsl'].prefix, #
    ...
    def cms_wrapper(self):
        shutil.move(
            join_path(self.prefix.bin, "Herwig"),
            join_path(self.prefix.bin, "Herwig-cms"),
        )
        install(
            join_path(os.path.dirname(__file__), "Herwig"),
            join_path(self.prefix.bin, "Herwig"),
        )
