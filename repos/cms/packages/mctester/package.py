...
class Mctester(AutotoolsPackage):
    ...
    version(
        "1.25.1",
        sha256="b039204af06e1bf0d9d9b7699c876c154e92c2df2f0d26af0e1c9c77d7fb0008",
        url="https://gitlab.cern.ch/cvsmctst/mc-tester/-/archive/v1.25.1/mc-tester-v1.25.1.tar.gz",
    )
    version(
        "1.25.0a",
        sha256="d84f7b14a7bf7e7f71b4fbb1af046a07bdbfd814003843f14b29e508435453f3",
    )
    ...
    def configure_args(self):
        args = [
            ...
            "--with-root=" + self.spec["root"].prefix,
        ]
        return args
    ...
    def do_stage(self, mirror_only=False):
        ...
        for fn in os.listdir(join_path(self.stage.source_path, dn)):
            shutil.move(
                join_path(self.stage.source_path, dn, fn),
