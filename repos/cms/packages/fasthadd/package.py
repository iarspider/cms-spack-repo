...
class Fasthadd(MakefilePackage):
    ...
    version(
        "2.3",
        url=f"https://raw.githubusercontent.com/cms-sw/cmssw/{commit}/DQMServices/Components/bin/fastHadd.cc",
        expand=False,
    ...
    def install(self, spec, prefix):
        ...
        flags = [
            ...
            "ROOTFilePB.pb.cc",
            "./fastHadd.cc",
            "-I" + self.spec["protobuf"].prefix.include,
            "-L" + self.spec["protobuf"].prefix.lib,
            "-lprotobuf",
        ]
