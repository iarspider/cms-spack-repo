...
class Pythia6(AutotoolsPackage):
    ...
    version(
        "6.4.26",
        url="https://service-spi.web.cern.ch/service-spi/external/MCGenerators/distribution/pythia6/pythia6-426-src.tgz",
    ...
    def configure_args(self):
        ...
        args = [
            "--with-hepevt=4000",
            "--prefix=" + join_path(self.stage.path, "temp_prefix"),
            "--disable-shared",
            "--enable-static",
        ]
    ...
    def install(self, spec, prefix):
        ...
        install_tree(
            join_path(self.stage.path, "temp_prefix", "include"), prefix.include
        )
