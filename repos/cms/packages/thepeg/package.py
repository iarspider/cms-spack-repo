...
class Thepeg(AutotoolsPackage):
    ...
    version(
        "2.2.2",
        sha256="97bf55d4391b0a070a3303d3845f8160afec403f1573dfb0e857709ad6262e3e",
    )
    version(
        "2.2.1",
    ...
    patch("thepeg-2.1.1.patch", when="@2.1.1:2.2.2", level=0)
    patch("LesHouchesFileReader.patch", when="@2.2.2:")  # -- CMS

    force_autoreconf = True
    install_libtool_archives = True  # -- CMS
    ...
    def configure_args(self):
        ...
        # if self.spec.satisfies('@2.0.3:'): -- CMS: doesn't use rivet
