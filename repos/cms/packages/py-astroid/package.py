...
class PyAstroid(PythonPackage):
    ...
    depends_on("py-wrapt@1.11:", when="@2.12.10: ^python@:3.10", type=("build", "run"))
    depends_on("py-wrapt@1.14:", when="@2.12.10: ^python@3.11:", type=("build", "run"))
    # end CMS
    ...
    depends_on("py-setuptools@62.6:", when="@2.12.10:", type=("build", "run")) # CMS: remove upper limit
