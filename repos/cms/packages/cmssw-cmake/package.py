...
class CmsswCmake(Package):
    ...
    resource(
        name="cmaketools",
        git="https://github.com/gartung/cmaketools.git",
    ...
    resource(
        name="scram2cmake",
        git="https://github.com/gartung/scram2cmake.git",
        commit="034c581",
    ...
    def install(self, spec, prefix):
        ...
        with working_dir("spack-build", create=True):
            ...
            if sys.platform == "darwin":
                options.append(
                    "-DUUID_INCLUDE_DIR=%s/include" % self.spec["libuuid"].prefix
                )
                options.append("-DUUID_ROOT_DIR=%s" % self.spec["libuuid"].prefix)
            args = [
                "-DCMakeTools_DIR=%s/cmaketools" % self.stage.source_path,
                ...
                "-DSIGCPP_INCLUDE_DIR=%s/sigc++-2.0"
                % self.spec["libsigcpp"].prefix.include,
                "-DSHERPA_INCLUDE_DIR=%s/SHERPA-MC"
                % self.spec["sherpa"].prefix.include,
                ...
                "-DPYTHON_INCLUDE_DIR=%s/python%s"
                % (
