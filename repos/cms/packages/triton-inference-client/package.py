...
class TritonInferenceClient(CMakePackage, CudaPackage):
    ...
    resource(name='model_config.cc', expand=False, sha256='44729ccd0928cc0697b94e799a479b7374c64430033ab0a9f56d35f64a35d086',
             placement={'model_config.cc': 'src/c++/library/model_config.cc'},
             url='file://' + os.path.dirname(__file__) + '/model_config.cc')
    resource(name='common', git='https://github.com/triton-inference-server/common.git', commit='249232758855cc764c78a12964c2a5c09c388d87',
    ...
    def cmake_args(self):
        ...
        define = self.define
        args = [define('CMAKE_INSTALL_LIBDIR', 'lib'),
