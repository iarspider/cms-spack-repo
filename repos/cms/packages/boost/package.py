    ...
    def patch(self):
        ...
        with open("user-config.jam", "w") as jam:
            ...
            if self.spec.satisfies("target=aarch64:"):
                jam.write(
                    'using gcc : : : <cxxflags>"-march=armv8-a -mno-outline-atomics" <cflags>"-march=armv8-a -mno-outline-atomics" ;\n'
                )
            if self.spec.satisfies("target=ppc64le:"):
                jam.write(
                    'using gcc : : : <cxxflags>"-mcpu=power8 -mtune=power8 --param=l1-cache-size=64 --param=l1-cache-line-size=128 --param=l2-cache-size=512" <cflags>"-mcpu=power8 -mtune=power8 --param=l1-cache-size=64 --param=l1-cache-line-size=128 --param=l2-cache-size=512" ;\n'
                )
